...
def initialize_memory() -> None:
    ...
    COLLECTION = CLIENT.get_or_create_collection(name="eloqui_conversation_memory")
    try:
        CLIENT.persist()
