...
openai.api_key = os.environ.get('ELOQUI_API_KEY')
...
def create_system_memory_message(message: str) -> dict:
    return {'role': 'system', 'name': 'Eloqui_memory', 'content': message}

def create_assistant_message(message: str) -> dict:
    return {'role': 'assistant', 'name': 'Eloqui', 'content': message}
